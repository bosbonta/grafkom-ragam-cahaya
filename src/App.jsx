...
function App() {
  useEffect(() => {
    ...
    dlFolder.add(dl.position, 'x', -2, 4, 0.5);
    dlFolder.add(dl.position, 'y', -2, 4, 0.5);
    dlFolder.add(dl.position, 'z', -2, 4, 0.5);
    ...
    const sl = new THREE.SpotLight(0xffffff, 1, 8, Math.PI / 8, 0, 0);
    ...
    slFolder.add(sl.position, 'x', -2, 4, 0.5);
    slFolder.add(sl.position, 'y', -2, 4, 0.5);
    slFolder.add(sl.position, 'z', -2, 4, 0.5);
    ...
    const hlHelper = new THREE.HemisphereLightHelper(hl, 2);
